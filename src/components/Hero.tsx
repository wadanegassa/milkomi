      ...
      <div className="relative z-10 h-full pt-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl">
            <p className="inline-flex items-center gap-2 rounded-full border border-foreground/10 bg-background/40 px-3 py-1 text-xs text-foreground/80">
              <span className="h-1.5 w-1.5 rounded-full bg-accent" aria-hidden="true" />
              Milkomi Hotel
            </p>
            <h1 className="mt-4 font-heading text-4xl sm:text-6xl leading-[1.02] tracking-tight">
              {title}
            </h1>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                ...
                {secondaryCta && (
                  <Link
                    ...
                    className="inline-flex items-center justify-center rounded-full border border-foreground/15 bg-background/40 px-6 py-3 text-sm font-semibold text-foreground/90 backdrop-blur hover:bg-surface/60"
                  >
                    {secondaryCta.label}
                  </Link>
                )}
