          ...
          <div className="grid gap-10 md:grid-cols-12 items-start">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 text-foreground/80 leading-relaxed">
                Each room at Senaf International Hotel is thoughtfully furnished with your comfort in mind. Choose from our range of rooms and suites — all featuring en-suite bathrooms, reliable Wi-Fi, and dedicated workspace areas.
              </p>
