          ...
          <Reveal>
            <div className="grid gap-10 md:grid-cols-12 items-center">
              <div className="md:col-span-7">
                <h2 className="font-heading text-3xl">Welcome to Milkomi Hotel</h2>
                <p className="mt-4 text-foreground/80 leading-relaxed">
                  Nestled in the heart of Nekemte, East Welega, Milkomi Hotel offers a perfect blend of contemporary elegance and authentic Oromo hospitality. Whether you are visiting for business or leisure, every detail of your stay is crafted to make you feel at home.
                </p>
                <div className="mt-8">
                  <Link
                    href="/about"
              ...
              <div className="relative overflow-hidden rounded-3xl border border-foreground/10 bg-surface/20">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="Milkomi Hotel events and conference hall"
                    fill
              ...
              <div className="relative overflow-hidden rounded-3xl border border-foreground/10 bg-surface/20">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="Milkomi Hotel restaurant and dining"
                    fill
                    sizes="(max-width: 768px) 100vw, 50vw"
                    className="object-cover"
                    loading="lazy"
          ...
          <Reveal>
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-3 text-sm text-foreground/70">
                  Hear what our guests say about their experience at Milkomi Hotel.
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-3 text-sm text-foreground/70">
                  Browse photos of our rooms, restaurant, event spaces, and the welcoming ambiance of Milkomi Hotel.
                </p>
              </div>
              <Link
                href="/gallery"
          ...
          <Reveal>
            <div className="relative overflow-hidden rounded-3xl border border-foreground/10 bg-surface/25">
              ...
              <div className="relative p-8 md:p-10 grid gap-6 md:grid-cols-12 items-center">
                <div className="md:col-span-7">
                  <h2 className="font-heading text-3xl">Ready to experience Milkomi Hotel?</h2>
                  <p className="mt-4 text-foreground/80 leading-relaxed">
