...
export default async function OffersPage() {
  return (
    <PageLayout>
      <Hero title="Offers & Packages" tagline="Exclusive rates and curated packages designed to make your stay at Milkomi Hotel even more memorable." imageSrc="https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=1920&q=85" />
