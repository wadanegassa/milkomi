      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
        <Reveal>
          ...
          <p className="mt-4 text-foreground/80 leading-relaxed">
            From complimentary high-speed Wi-Fi throughout the property to backup generator power, 24/7 front desk assistance, and secure parking — Milkomi Hotel ensures your comfort and convenience every moment of your stay.
          </p>
        </Reveal>
